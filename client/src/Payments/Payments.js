...
const Payments = () => {
  ...
  useEffect(() => {
    if (
      paymentsInfo.endpointOptions &&
      paymentsInfo.endpointOptions.length >= 1
    ) {
        ...
        <div className="payment-page__options endpoint-options">
          ...
          <div className="content-type" style={{ marginTop: 19 }}>
            ...
            <div style={{ display: "flex" }}>
              <input type="text" placeholder="token or name:password" />
              <select
                name=""
                id=""
                style={{
              ...
              >
                ...
                <option value="">Basic Authentication</option>
              </select>
            </div>
          </div>
